...
2 console.log("Node is a element");
3 }
```
...
```
1   var textNode = document.createTextNode("一个TextNode");
```
### cloneNode
...
>摘取文章：[http://luopq.com/2015/11/30/javascript-dom/](http://luopq.com/2015/11/30/javascript-dom/)
